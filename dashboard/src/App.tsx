    ...
    <div className="text-[var(--text-primary)] min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <ErrorBoundary name="Health">
          <div id="health" className="md:col-span-2 scroll-mt-20"><HealthPanel data={healthWithGrpc} stale={dashStale} /></div>
        </ErrorBoundary>
        ...
        <ErrorBoundary name="Scheduler">
          <div id="scheduler" className="md:col-span-2 scroll-mt-20"><SchedulerPanel data={dashboard.scheduler} onTriggerJob={handleTriggerJob} stale={dashStale} /></div>
        </ErrorBoundary>
      ...
      <ConnectionIndicator dashGrpcState={dashState} grpcState={grpcState} grpcExhausted={grpcExhausted} onReconnectDashGrpc={dashConnect} onDisconnectDashGrpc={dashDisconnect} onReconnectGrpc={grpcConnect} onDisconnectGrpc={grpcDisconnect} />
    </div>
  );
}
export default App;

...
## Session 38: Dashboard多Worker可视化

**Date**: 2026-06-22
**Task**: Dashboard多Worker可视化
**Branch**: `feat/dashboard-file-browser`

### Summary

实现 Dashboard 多 Worker 可视化：SubtaskSummary 添加 assigned_worker 字段并贯穿 gRPC-Web + 事件管道；WorkersPanel 接受 tasks prop 显示每个 Worker 的活跃 subtask 计数和详情列表；TaskDetail 子任务行显示 Worker badge。解决 main 合并冲突，修复 cargo fmt/clippy/ruff CI 问题。
